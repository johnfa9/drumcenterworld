<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" 
    CodeBehind="AddProduct.aspx.cs" Inherits="drumcenterworld.AddProduct" %>
 ...
 <label>Product Photo:</label>
    ...
    <asp:TextBox ID="TextBoxPrice" runat="server" Height="22px"></asp:TextBox>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
            ControlToValidate="TextBoxPrice" ErrorMessage="Price is required" 
            ForeColor="Red"></asp:RequiredFieldValidator>
    </div>
    <div>
    ...
    <asp:TextBox ID="TextBoxAvailableQty" runat="server"></asp:TextBox>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
            ControlToValidate="TextBoxAvailableQty" ErrorMessage="Available Qty is Required" 
            ForeColor="Red"></asp:RequiredFieldValidator>
        </div>
    <div>
